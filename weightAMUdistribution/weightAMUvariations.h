...
public:
  ...
  void weightAMUvariations::read(const char *filename1, const char *filename2, const char *filename3){
...
double weightAMUvariations::getWeightInternal(const double x, const double y, const double Enu, const double mlep, const int isAntinu, double *weights, int absolute){
...
double weightAMUvariations::getWeight(const double x, const double y, const double Enu, const double mlep, const int isAntinu, double *weights){
...
double weightAMUvariations::getAbsolute(const double x, const double y, const double Enu, const double mlep, const int isAntinu, double *weights){
  // this is just a wrapper.   At the moment, I don't need any such thing, consider eliminating it.
...
double weightAMUvariations::getF1(const double x, const double y, const double Enu, const double mlep, const int isAntinu, double *weights){
  int absolute = 11;
  return getWeightInternal(x, y, Enu, mlep, isAntinu, weights, absolute);
}

double weightAMUvariations::getF2(const double x, const double y, const double Enu, const double mlep, const int isAntinu, double *weights){
  int absolute = 12;
  return getWeightInternal(x, y, Enu, mlep, isAntinu, weights, absolute);
}

double weightAMUvariations::getF3(const double x, const double y, const double Enu, const double mlep, const int isAntinu, double *weights){
  int absolute = 13;
  return getWeightInternal(x, y, Enu, mlep, isAntinu, weights, absolute);
}

double weightAMUvariations::getF1withQ2(const double x, const double Q2, const double Enu, const double mlep, const int isAntinu, double *weights){
  int absolute = 11;
  //double MN = 0.5 * (0.93827208943 + 0.93956542052);
...
double weightAMUvariations::getF2withQ2(const double x, const double Q2, const double Enu, const double mlep, const int isAntinu, double *weights){
  int absolute = 12;
  //double MN = 0.5 * (0.93827208943 + 0.93956542052);
  double y = Q2 / (2.0 * x * MN * Enu);
  return getWeightInternal(x, y, Enu, mlep, isAntinu, weights, absolute);
...
double weightAMUvariations::getF3withQ2(const double x, const double Q2, const double Enu, const double mlep, const int isAntinu, double *weights){
  int absolute = 13;
  //double MN = 0.5 * (0.93827208943 + 0.93956542052);
  double y = Q2 / (2.0 * x * MN * Enu);
  return getWeightInternal(x, y, Enu, mlep, isAntinu, weights, absolute);
...
double weightAMUvariations::getIntegral(const double Enu, const double mlep, const int isAntinu, double *weights, double W){
...
double weightAMUvariations::getOneCrossSection(double F1, double F2, double F3, double x){
...
double weightAMUvariations::getFourXSForInterpolation(const double array1[][Q2BINS], const double array2[][Q2BINS], const double array3[][Q2BINS], double fourXS[4], double x){
...
double weightAMUvariations::getFourValuesForInterpolation(double x, double y, const double array[][Q2BINS], double fourval[4]){
...
double weightAMUvariations::getInterpolatedValueFromFour(double x, double y, double array[4]){
...
double weightAMUvariations::getInterpolatedValueFromFour(double x, double y, double q11, double q12, double q21, double q22){
...
//double weightAMUvariations::interpolate2D(double x, double y, const double array[XBINS][Q2BINS], const std::vector<double> xbins, const std::vector<double> ybins){
  double weightAMUvariations::interpolate2D(double x, double y, const double array[][Q2BINS]){
