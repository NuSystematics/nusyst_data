...
Pion absorption reweighting templates.
...
"PionAbsWeighter"`). The exact list of files currently included is below
...
```bash
scripts/download_data.sh -o PionAbsWeighter
```
...
```
reweights_TH2D_1000180400.root
```
